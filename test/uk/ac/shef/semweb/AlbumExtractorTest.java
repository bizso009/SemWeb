...
public class AlbumExtractorTest extends TestCase {

    private AlbumExtractor extractor;
    
   public void testExtract() throws IllegalStateException, ClientProtocolException, SAXException, IOException, ParserConfigurationException{
       ...
       assertNotNull(res);
       Property p = model.createProperty("http://poplar.dcs.shef.ac.uk/~u0082/intelweb2/intelweb.rdf#hasGenre");
